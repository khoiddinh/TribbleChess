...
public class MoveGenerationPrecomputeTest {
    ...
    void testGenerateRookAttackMask() {
        ...
        assertEquals(expectedMask, actualMask,
                "Rook attack mask for a8 is incorrect.");
        ...
        assertEquals(expectedMask, actualMask,
                "Rook attack mask for f5 is incorrect.");
        ...
        assertEquals(expectedMask, actualMask,
                "Rook attack mask for h8 is incorrect.");
    }
    @Test
    void testRaysLeft() {
        long actualRay = MoveGenerationPrecompute.getRays()[0][0];
    ...
    @Test
    void testRaysUpLeft() {
        long actualRay = MoveGenerationPrecompute.getRays()[1][20];
        printBitBoard(actualRay);
        long expectedRay =
                0b00100000_00010000_00000000_00000000_00000000_00000000_00000000_00000000L;
        assertEquals(expectedRay, actualRay, "Up-left ray for 20 is incorrect.");
    }

    @Test
    void testRaysUp() {
        long actualRay = MoveGenerationPrecompute.getRays()[2][35];
        long expectedRay =
                0b00010000_00010000_00010000_00010000_00000000_00000000_00000000_00000000L;
        assertEquals(expectedRay, actualRay, "Up ray for 35 is incorrect.");
    }

    @Test
    public void testRaysUpRight() {
        long actualRay = MoveGenerationPrecompute.getRays()[3][27];
        long expectedRay =
                0b00000010_00000100_00001000_00000000_00000000_00000000_00000000_00000000L;
        assertEquals(expectedRay, actualRay, "Up-right ray for 27 is incorrect.");
    }

    @Test
    public void testRaysRight() {
        long actualRay = MoveGenerationPrecompute.getRays()[4][24];
        long expectedRay =
                0b00000000_00000000_00000000_01111111_00000000_00000000_00000000_00000000L;
        assertEquals(expectedRay, actualRay, "Right ray for 24 is incorrect.");
    }

    @Test
    public void testRaysDownRight() {
        long actualRay = MoveGenerationPrecompute.getRays()[5][45];
        long expectedRay =
                0b00000000_00000000_00000000_00000000_00000000_00000000_00000010_00000001L;
        assertEquals(expectedRay, actualRay, "Down-right ray for 45 is incorrect.");
    }

    @Test
    public void testRaysDown() {
        long actualRay = MoveGenerationPrecompute.getRays()[6][19];
        long expectedRay =
                0b00000000_00000000_00000000_00010000_00010000_00010000_00010000_00010000L;
        assertEquals(expectedRay, actualRay, "Down ray for 19 is incorrect.");
    }

    @Test
    public void testRaysDownLeft() {
        long actualRay = MoveGenerationPrecompute.getRays()[7][15];
        long expectedRay =
                0b00000000_00000000_00000010_00000100_00001000_00010000_00100000_01000000L;
        assertEquals(expectedRay, actualRay, "Down-left ray for 15 is incorrect.");
    }

    @Test
    public void testKnightMask() {
        long actualMask = MoveGenerationPrecompute.getKnightAttackMasks()[0];
        long expectedMask =
        ...
        actualMask = MoveGenerationPrecompute.getKnightAttackMasks()[7];
        expectedMask =
        ...
        actualMask = MoveGenerationPrecompute.getKnightAttackMasks()[56];
        expectedMask =
        ...
        actualMask = MoveGenerationPrecompute.getKnightAttackMasks()[63];
        expectedMask =
        ...
        actualMask = MoveGenerationPrecompute.getKnightAttackMasks()[27]; //d5
    ...
    public void testPawnMask() {
        long actualMask = MoveGenerationPrecompute.getWhitePawnMoveMasks()[48];
        long expectedMask =
                0b00000000_00000000_00000000_00000000_10000000_10000000_00000000_00000000L;
        assertEquals(expectedMask, actualMask, "Pawn mask for pos 48 is incorrect.");

        actualMask = MoveGenerationPrecompute.getWhitePawnAttackMasks()[55];
        expectedMask =
        ...
        actualMask = MoveGenerationPrecompute.getWhitePawnAttackMasks()[54];
        expectedMask =
                0b00000000_00000000_00000000_00000000_00000000_00000101_00000000_00000000L;
        assertEquals(expectedMask, actualMask, "Pawn mask for pos 55 is incorrect.");

        actualMask = MoveGenerationPrecompute.getBlackPawnMoveMasks()[8];
        expectedMask =
                0b00000000_00000000_10000000_10000000_00000000_00000000_00000000_00000000L;
        assertEquals(expectedMask, actualMask, "Pawn mask for pos 8 is incorrect.");

        actualMask = MoveGenerationPrecompute.getBlackPawnAttackMasks()[9];
        expectedMask =
                0b00000000_00000000_10100000_00000000_00000000_00000000_00000000_00000000L;
    ...
    public void testMagicSlidingAttack() { // edge case max hash
        ...
        long actual = tables.getSlidingMagicAttack(63,
                orBitBoardArray(board.whiteBitBoards()) |
                        orBitBoardArray(board.blackBitBoards()), 2);
        long expected =
